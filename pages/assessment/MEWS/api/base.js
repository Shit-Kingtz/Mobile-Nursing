...
// 详情ajax
let getAssessmentInfo = (id) => uniRequest.get(kfsys.prefixUrl + "api/v1/Hospitalized/NursingAssessment/PatientMEWS/get?MEWSID=" + id)

// 提交ajax
let saveAssessment = (params, type, callback) => uni.request({
	url: kfsys.prefixUrl + 'api/v1/Hospitalized/NursingAssessment/PatientMEWS',
	method: type,
...
export default {
	...
	submit(params, id, type, callback) {
		let ajaxType = type == 'create' ? 'POST' : 'PUT',
			ajaxParams = type == 'create' ? params : {'MEWSID': id, ...params}
